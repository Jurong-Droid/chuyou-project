<template>
  <el-date-picker size="mini" v-model="updateValue" type="daterange" align="right" unlink-panels range-separator="至"
                  :start-placeholder="startVaule" :end-placeholder="endValue" :picker-options="pickerOptions">
  </el-date-picker>
</template>
