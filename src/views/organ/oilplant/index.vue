<template>
  <div class="app-container">
    <div>
      <el-input size="mini" v-model="listLoading" placeholder="输入采油厂" style="width:15%"></el-input>
    ...
    <div>
      <el-table :data="leftlist" border fit highlight-current-row style="font-size: 16px" :header-cell-style="{background:'#f5f7fa',color:'#409EFF'}" >
        <el-table-column align="center" label="采油厂" prop="oilplant" min-width="12"></el-table-column>
    ...
    <el-dialog title="添加" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempinfo" label-position="left" label-width="15%">
        ...
        <el-form-item label="油田名称" required>
          <el-select v-model="tempinfo.fid" placeholder="请选择油田" style="width: 40%">
