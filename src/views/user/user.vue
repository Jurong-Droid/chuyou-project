...
<div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="手机号码" prop="phone" style="width: 60px;"></el-table-column>
        <el-table-column align="center" label="电子邮箱" prop="email" style="width: 60px;"></el-table-column>
        ...
        <el-table-column align="center" label="管理" width="220" v-permission="'user:update'">
            <template slot-scope="scope">
                ...
                <el-button type="danger" icon="delete" v-if="scope.row.userId!=userId " @click="removeUser(scope.$index)" v-permission="'user:delete'">删除
                </el-button>
            </template>
        </el-table-column>
    </el-table>
