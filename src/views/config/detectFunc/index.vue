      ...
      <el-form>
        <el-form-item>
          <el-button
            ...
            icon="plus"
            @click="showCreate"
            v-permission="'detectFunc:operate'"
            >添加
          </el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table-column align="center" label="管理" min-width="15%">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            type="danger"
            icon="delete"
            @click="deleteDetectFunc(scope.$index)"
            v-permission="'detectFunc:operate'"
            >删除</el-button
          >
        </template>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="600px">
      ...
      >
        <el-form-item label="检测方法名称" required>
          <el-input
            type="text"
            autosize
            v-model="tempDetectFuncVo.detectFuncName"
            placeholder="请输入名称"
          >
          </el-input>
        </el-form-item>
        <el-form-item label="检测方法说明">
          <el-input
            type="textarea"
            show-word-limit
            v-model="tempDetectFuncVo.funcFor"
            maxlength="100"
            placeholder="请输入内容"
          >
          </el-input>
        ...
        <el-form-item label="标注框颜色" required>
          <el-color-picker
            v-model="tempDetectFuncVo.tagColor"
            show-alpha
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          type="primary"
          @click="saveDetectFunc"
          >创 建</el-button
        >
        <el-button type="primary" v-else @click="saveDetectFunc"
          >修 改</el-button
        >
      </div>
    </el-dialog>
