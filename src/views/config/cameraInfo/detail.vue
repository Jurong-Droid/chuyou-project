<template>
  <div class="app-container">
    <el-page-header @back="callback" content="摄像头信息详情"> </el-page-header>
      ...
      <el-descriptions class="margin-top" :column="2" border>
        ...
        <el-descriptions-item>
          ...
          <div
            ...
            v-for="i in tempCamera.roles"
            :key="i.roleId"
          >
            <el-tag type="primary">{{ i.roleName }}</el-tag>
          </div>
        </el-descriptions-item>
      </el-descriptions>
    </div>
      ...
      <el-row type="flex">
        <el-col :span="24">
          <div class="grid-content bg-purple-light">
            <p style="padding-left: 10px">摄像头关联的检测算法列表</p>
          </div>
        </el-col>
      </el-row>
      <el-table
