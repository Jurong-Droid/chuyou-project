<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button size="mini" type="primary" icon="plus" v-permission="'cameraInfo:add'" @click="showCreate">添加
      </el-button>
    </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempCamera" label-position="left" label-width="15%">
        ...
        <el-form-item label="摄像头类型" required>
          <el-select v-model="tempCamera.cameraType" placeholder="请选择摄像头类型" style="width: 40%">
            <el-option v-for="item in cameraType" :key="item.id" :label="item.name" :value="item.id"/>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="视频流地址" required>
          <el-input type="textarea" autosize v-model="tempCamera.rtsp" placeholder="摄像头的直播流源 (支持RTSP和RTMP)"
                    style="width: 40%">
          </el-input>
        </el-form-item>
