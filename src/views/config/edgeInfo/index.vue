<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button size="mini" type="danger" icon="plus" v-permission="'edgeInfo:list'" @click="resetHeartbeat">重置状态检测
      </el-button>
    </div>
    ...
    <el-dialog title="绑定摄像头" :visible.sync="dialogCameraVisible">
      <el-form class="small-space" :model="tempCamera" label-position="left" label-width="15%">
        <el-form-item label="摄像头名称" required>
          <el-cascader v-model="tempCamera.cameraIds" :options="options" :props="defaultProps" filterable clearable
                       placeholder="请选择摄像头信息" style="width: 40%"/>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
